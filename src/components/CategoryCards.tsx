...
const categories = [
  {
    name: 'Candles',
    href: '/product-listings?category=candles',
    imageSrc: '/images/placeholders/product-1.png',
  },
  {
    name: 'Soaps',
    href: '/product-listings?category=soaps',
    imageSrc: '/images/placeholders/product-2.png',
  },
  {
    name: 'Kits',
    href: '/product-listings?category=kits',
                ...
                {categories.map((category) => (
                  ...
                  >
                    <span aria-hidden="true" className="absolute inset-0">
                      <Image src={category.imageSrc} alt="" fill className="h-full w-full object-cover object-center" />
                    </span>
                    <span
                      aria-hidden="true"
