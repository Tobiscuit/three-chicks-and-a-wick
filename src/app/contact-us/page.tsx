            ...
            <div className="p-8 md:p-12 bg-neutral-light/50">
              ...
              <div className="mt-10 pt-8 border-t border-neutral-dark/10">
                 ...
                 <div className="flex space-x-4">
                    <Link href="#" className="text-neutral-dark/60 hover:text-primary transition-colors"><Instagram size={32} /></Link>
                    <Link href="#" className="text-neutral-dark/60 hover:text-primary transition-colors"><Facebook size={32} /></Link>
                    <Link href="#" className="text-neutral-dark/60 hover:text-primary transition-colors"><Twitter size={32} /></Link>
                 </div>
              </div>
            </div>
            ...
            <div className="p-8 md:p-12">
              <form action="#" method="POST" className="space-y-6">
                <div>
                  ...
                  <input type="text" name="name" id="name" placeholder="Your Name" className="w-full px-4 py-3 bg-neutral-light/70 rounded-lg border-2 border-transparent hover:border-[var(--subtle-border)] focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/30 transition" />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-bold text-neutral-dark/90 mb-2">Email Address</label>
                  <input type="email" name="email" id="email" placeholder="you@example.com" className="w-full px-4 py-3 bg-neutral-light/70 rounded-lg border-2 border-transparent hover:border-[var(--subtle-border)] focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/30 transition" />
                </div>
                 <div>
                  <label htmlFor="subject" className="block text-sm font-bold text-neutral-dark/90 mb-2">Subject</label>
                  <input type="text" name="subject" id="subject" placeholder="How can we help?" className="w-full px-4 py-3 bg-neutral-light/70 rounded-lg border-2 border-transparent hover:border-[var(--subtle-border)] focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/30 transition" />
                </div>
                <div>
                  <label htmlFor="message" className="block text-sm font-bold text-neutral-dark/90 mb-2">Message</label>
                  <textarea name="message" id="message" rows={5} placeholder="Your message..." className="w-full px-4 py-3 bg-neutral-light/70 rounded-lg border-2 border-transparent hover:border-[var(--subtle-border)] focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/30 transition"></textarea>
                </div>
                <div>
